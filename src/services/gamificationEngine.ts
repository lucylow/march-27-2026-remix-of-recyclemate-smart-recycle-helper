...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    requirement: "250 items",
    checkUnlocked: (s) => s.totalItems >= 250,
  },
  {
    id: "3_day_streak",
  ...
  },
  {
    ...
    emoji: "🧪",
    description: "Recycle 10 different materials",
    requirement: "10 materials",
    checkUnlocked: (s) => s.uniqueMaterials >= 10,
  },
  {
    id: "level_5",
    label: "Rising Star",
  ...
  },
  {
    ...
    checkUnlocked: (s) => s.challengesCompleted >= 10,
  },
  {
    id: "500_points",
  ...
  },
  {
    ...
    label: "Night Owl",
    emoji: "🦉",
    description: "Scan after 10 PM",
    requirement: "Late scan",
    checkUnlocked: () => new Date().getHours() >= 22,
  },
  {
    id: "early_bird",
    label: "Early Bird",
    emoji: "🐦",
    description: "Scan before 7 AM",
    requirement: "Early scan",
    checkUnlocked: () => new Date().getHours() < 7,
  },
];
